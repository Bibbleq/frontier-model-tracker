...
- `manifest.json` is the machine-readable form of [`../docs/data-contract.md`](../docs/data-contract.md): both version numbers, and a byte length and SHA-256 for every published file. Consumers fetch it first to check versions and skip unchanged downloads.
